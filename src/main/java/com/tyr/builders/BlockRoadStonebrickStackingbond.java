...
public class BlockRoadStonebrickStackingbond extends BlockFalling
{
	protected static final AxisAlignedBB ROAD_STONEBRICK_STACKINGBOND_AABB = new AxisAlignedBB(0.0F, 0.0F, 0.0F, 1.0F , 0.875F, 1.0F);
	
	public BlockRoadStonebrickStackingbond(String blockName)
	{
		super(Material.ROCK);
    ...
    {
        return ROAD_STONEBRICK_STACKINGBOND_AABB;
    }
