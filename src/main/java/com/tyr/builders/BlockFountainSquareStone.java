...
public class BlockFountainSquareStone extends Block
{
	public static final PropertyInteger LEVEL = PropertyInteger.create("level", 0, 1);
	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	//EDGES
	protected static final AxisAlignedBB FOUNTAIN_EDGE1_AABB = new AxisAlignedBB(0.0625F, 0.25F, 0.0625F, 0.9375F, 0.5F, 0.125F);
	protected static final AxisAlignedBB FOUNTAIN_EDGE2_AABB = new AxisAlignedBB(0.0625F, 0.25F, 0.125F, 0.125F, 0.5F, 0.875F);
	protected static final AxisAlignedBB FOUNTAIN_EDGE3_AABB = new AxisAlignedBB(0.0625F, 0.25F, 0.875F, 0.9375F, 0.5F, 0.9375F);
	protected static final AxisAlignedBB FOUNTAIN_EDGE4_AABB = new AxisAlignedBB(0.875F, 0.25F, 0.125F, 0.9375F, 0.5F, 0.875F);
	//BASE
	protected static final AxisAlignedBB FOUNTAIN_BASE_AABB = new AxisAlignedBB(0.4375F, 0.1875F, 0.4375F, 0.5625F, 0.9375F, 0.5625F);
	//BOWL
	protected static final AxisAlignedBB FOUNTAIN_BOWL_AABB = new AxisAlignedBB(0.0F, 0.0F, 0.0F, 1.0F, 0.1875F, 1.0F);
	//BOUNDING
	protected static final AxisAlignedBB FOUNTAIN_BOUNDING_AABB = new AxisAlignedBB(0.0F, 0.0F, 0.0F, 1.0F, 0.9375F, 1.0F);
	
	public BlockFountainSquareStone(String blockName)
	{
		super(Material.ROCK);
    ...
    public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn)
    {
        ...
        float f = (float)pos.getY() + (11.0F + (float)(2 * i)) / 16.0F;
