...
public class BlockRoadCobblestoneSlab extends BlockFalling
{
	protected static final AxisAlignedBB ROAD_COBBLESTONE_SLAB_AABB = new AxisAlignedBB(0.0F, 0.0F, 0.0F, 1.0F , 0.375F, 1.0F);
	
	public BlockRoadCobblestoneSlab(String blockName)
	{
		super(Material.ROCK);
    ...
    {
        return ROAD_COBBLESTONE_SLAB_AABB;
    }
    ...
    public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn)
    {
    	...
    	{
            entityIn.motionX *= 1.015D;
            entityIn.motionZ *= 1.015D;
    	}
    }
