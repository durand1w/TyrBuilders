...
public class BlockJarHoney extends Block
{
	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	protected static final AxisAlignedBB JAR_HONEY_AABB = new AxisAlignedBB(0.1875F, 0.0F, 0.1875F, 0.8125F, 0.75F, 0.8125F);
	
	public BlockJarHoney(String blockName)
	{
		super(Material.IRON);
