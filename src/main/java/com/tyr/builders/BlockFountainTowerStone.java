...
public class BlockFountainTowerStone extends Block
{
	public static final PropertyInteger LEVEL = PropertyInteger.create("level", 0, 1);
	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	//TOP
	protected static final AxisAlignedBB FOUNTAIN_TOP_AABB = new AxisAlignedBB(0.1875F, 0.6875F, 0.1875F, 0.8125, 0.9375F, 0.8125);
	//BASE
	protected static final AxisAlignedBB FOUNTAIN_BASE_AABB = new AxisAlignedBB(0.4375F, 0.0625F, 0.4375F, 0.5625F, 1.0F, 0.5625F);
	//BOWL
	protected static final AxisAlignedBB FOUNTAIN_BOWL_AABB = new AxisAlignedBB(0.0F, 0.0F, 0.0F, 1.0F, 0.3125F, 1.0F);
	//BOUNDING
	protected static final AxisAlignedBB FOUNTAIN_BOUNDING_AABB = new AxisAlignedBB(0.0F, 0.0F, 0.0F, 1.0F, 0.9375F, 1.0F);
	
	public BlockFountainTowerStone(String blockName)
	{
		super(Material.ROCK);
