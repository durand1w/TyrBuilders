...
public class BlockRoadStonebrickStackingbondSlab extends BlockFalling
{
	protected static final AxisAlignedBB ROAD_STONEBRICK_STACKINGBOND_SLAB_AABB = new AxisAlignedBB(0.0F, 0.0F, 0.0F, 1.0F , 0.375F, 1.0F);
	
	public BlockRoadStonebrickStackingbondSlab(String blockName)
	{
		super(Material.ROCK);
    ...
    {
        return ROAD_STONEBRICK_STACKINGBOND_SLAB_AABB;
    }
