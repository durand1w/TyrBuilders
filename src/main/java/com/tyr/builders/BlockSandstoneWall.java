...
public class BlockSandstoneWall extends Block
{
    ...
    public BlockSandstoneWall(String blockName)
    {
		super (Material.ROCK);
    ...
    private boolean canConnectTo(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        //Custom To Each Wall Type
        return block == Blocks.BARRIER ? false : (block != this && !(block instanceof BlockFenceGate)  && !(block instanceof BlockWall) && !(block instanceof BlockStoneWall) && !(block instanceof BlockSandstoneWall) ? (iblockstate.getMaterial().isOpaque() && iblockstate.isFullCube() ? iblockstate.getMaterial() != Material.GOURD : false) : true);
    }
