...
public class BlockChainHeavyIron extends Block
{
	protected static final AxisAlignedBB CHAIN_HEAVY_IRON_AABB = new AxisAlignedBB(0.3125F, 0.0F, 0.3125F, 0.6875F, 1.0F, 0.6875F);
	
	public BlockChainHeavyIron(String blockName)
	{
		super(Material.IRON);
